...
erreicht. Der speziellste Fall muss also nach vorn. Mit frühem `return` in
jedem Zweig brauchst du nicht einmal `else`. Für den letzten Fall wandelst du
...
Den Zähler erhöhst du bei jedem Durchlauf.
...
Die Ausführung "fällt durch" (fall-through): Nach dem passenden `case` laufen
...
Sprungziele, keine Grenzen. Gewollt nutzt man das, um mehrere Fälle
